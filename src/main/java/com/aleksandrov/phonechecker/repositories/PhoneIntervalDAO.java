...
public interface PhoneIntervalDAO extends JpaRepository<PhoneInterval, Integer> {
    PhoneInterval findTop1ByPrefixEqualsAndEndIntervalGreaterThanEqualAndStartIntervalLessThanEqual(int Prefix, int End, int Start);
    ...
    PhoneInterval findInterval(int prefix, int number, int number2);
}
